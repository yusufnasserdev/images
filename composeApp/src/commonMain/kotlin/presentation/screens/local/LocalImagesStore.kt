...
import presentation.screens.local.LocalImagesStore.State

/**
 * LocalImages Store definition, including the State implementation.
 *
 */

interface LocalImagesStore : Store<Nothing, State, Any> {
...
class LocalImagesStoreFactory(
    ...
    /**
     * Provides LocalImagesStore creation.
     */

    fun create(): LocalImagesStore =
        object : LocalImagesStore, Store<Nothing, State, Any> by storeFactory.create(
